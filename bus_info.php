                      ...
                      $bus_times = explode(" ",$times);
                        ...
                        <div class="jumbotron">
                            <div class="container-fluid">
                                ...
                                <form action="bus_info.php?bus_id=<?php echo $selected_bus ?>&count=<?php echo isset($_POST['passenger_count']) ? $_POST['passenger_count'] : 0; ?>" method="post" class="form-horizontal">
    <!-- ... (your existing code) ... -->
